...
public interface BuildingRingService{
	/**
	 ...
	 * @return
	 */
    int updateBuildingRing(BuildingRing value, Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBuildingRing(BuildingRing value, Assist assist);
}
...
public interface RoleEmployeeDao{
	 ...
	 * @return
	 */
    int updateRoleEmployee(@Param("enti") RoleEmployee value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyRoleEmployee(@Param("enti") RoleEmployee value, @Param("assist") Assist assist);
}
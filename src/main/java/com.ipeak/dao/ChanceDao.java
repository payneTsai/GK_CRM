...
public interface ChanceDao{
	 ...
	 * @return
	 */
    int updateChance(@Param("enti") Chance value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyChance(@Param("enti") Chance value, @Param("assist") Assist assist);
}
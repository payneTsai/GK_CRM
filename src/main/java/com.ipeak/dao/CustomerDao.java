...
public interface CustomerDao{
	 ...
	 * @return
	 */
    int updateCustomer(@Param("enti") Customer value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCustomer(@Param("enti") Customer value, @Param("assist") Assist assist);
}
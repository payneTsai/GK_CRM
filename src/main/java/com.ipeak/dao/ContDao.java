...
public interface ContDao{
	 ...
	 * @return
	 */
    int updateCont(@Param("enti") Cont value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCont(@Param("enti") Cont value, @Param("assist") Assist assist);
}